...
@section('content')
    <form class="form-horizontal" action="{{route('admin.newspaper.store')}}" method="POST">
        {{csrf_field()}}
        <div class="card">
            <div class="card-body">
                <div class="row">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="newspaper_title" class="form-control" placeholder="Enter NewsPaper title">
                            </div><!--col-->
                        </div>
                        <div class="form-group row">
