                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="founded_by" class="form-control" placeholder="Enter Founded By" value="{{$newspaper->title}}">
                            </div><!--col-->
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="date" name="launch_date" class="form-control" placeholder="Enter launch Date" value="{{$newspaper->launch_date}}">
                            </div><!--col-->
                        </div>
                        <!--form-group-->
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea placeholder="Description" name="desc">{{$newspaper->description}}</textarea>
                            </div><!--col-->
                        </div>
