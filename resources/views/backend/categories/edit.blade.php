                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="category_title" class="form-control" placeholder="Enter City" value="{{$category->title}}">
                            </div><!--col-->
                        </div><!--form-group-->
                 ...
                 <div class="row mt-4 mb-4">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="checkbox" name="cat" @if($category->status == "1") checked @endif>
                            </div><!--col-->
                        </div><!--form-group-->
