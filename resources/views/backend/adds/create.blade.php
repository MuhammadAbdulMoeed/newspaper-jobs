...
@section('content')
    <form class="form-horizontal" id="addForm" action="{{route('admin.adds.store')}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="card">
            <div class="card-body">
                <div class="row">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                            <input type="number" name="total_pos" class="form-control" placeholder="Total Positions" required="required">
                            </div>
