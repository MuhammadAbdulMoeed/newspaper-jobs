...
<div id=wrapper_total>
            ...
            <div id="navigate">
               ...
               <p itemprop="description" color=#019875 style="font-size:1em;"><img itemprop="primaryImageOfPage" style="border-radius:0px;max-width:200px;width:80px;" align=left src="pk_img/newspaper-jobs.jpg" /> In Pakistan still most of the jobs are published in newspapers, so we can say that newspapers are still the biggest medium of providing jobs specially in government sector. Paperpk has collected all newspaper jobs at one place for job seekers of Pakistan. If you are searching a job don't miss the job ads advertised in Newspapers. </p>
               <div id=clear></div>
               <div id=search_bar>
                  <center>
                     <br/>
                     <form name=search_form action=https://paperpk.com/filter.php method=get onsubmit="return validate();">
