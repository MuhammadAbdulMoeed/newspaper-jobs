...
#show-ad-page-job-details-div {
    background: url("{{asset('/public/background-on-ad-back.png')}}") repeat !important;
    color: #325465;
}
         ...
         <!--
            ...
            March 03,2016</td>
                ...
                <div id=search_bar>
                  ...
                  <a href="{{url('company_add/'.$add->company_name)}}"><p style="font-size: 3em; font-weight: bold; color: purple"> More Jobs By {{$add->company_name}} </p> </a>
